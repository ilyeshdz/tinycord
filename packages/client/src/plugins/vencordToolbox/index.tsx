        ...
        >
            {(_, { isShown }) => (
                <HeaderBarIcon
                    ...
                    onClick={() => setShow(v => !v)}
                    tooltip={isShown ? null : "Tinycord Toolbox"}
...
export default definePlugin({
    name: "TinycordToolbox",
    description: "Adds a button to the titlebar that houses Tinycord quick actions",
