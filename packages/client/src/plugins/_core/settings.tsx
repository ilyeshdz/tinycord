...
const settings = definePluginSettings({
    settingsLocation: {
        ...
        description: "Where to put the Tinycord settings section",
        options: [
...
export default definePlugin({
    ...
    getInfoRows() {
        ...
        const rows = [`Tinycord ${gitHash}${additionalInfo}`];
