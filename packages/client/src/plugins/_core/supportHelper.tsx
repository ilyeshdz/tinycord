...
async function generateDebugInfoMessage() {
    ...
    const info = {
        Tinycord:
            `v${VERSION} • [${gitHash}](<https://github.com/tinycord/tinycord/commit/${gitHash}>)` +
    ...
    const commonIssues = {
        ...
        "Tinycord DevBuild": !IS_STANDALONE,
        ...
        async CHANNEL_SELECT({ channelId }) {
            ...
            if (!IS_UPDATER_DISABLED) {
                ...
                if (isOutdated) {
                    return Alerts.show({
                        title: "Hold on!",
                        body: <div>
                            <Forms.FormText>You are using an outdated version of Tinycord! Chances are, your issue is already fixed.</Forms.FormText>
            ...
            if (!IS_WEB && IS_UPDATER_DISABLED) {
                return Alerts.show({
                    title: "Hold on!",
                    body: <div>
                        <Forms.FormText>You are using an externally updated Tinycord version, which we do not provide support for!</Forms.FormText>
                        <Forms.FormText className={Margins.top8}>
                            Please either switch to an officially supported version of Tinycord, or
            ...
            if (!IS_STANDALONE && !settings.store.dismissedDevBuildWarning) {
                return Alerts.show({
                    title: "Hold on!",
                    body: <div>
                        <Forms.FormText>You are using a custom build of Tinycord, which we do not provide support for!</Forms.FormText>
    ...
    renderContributorDmWarningCard: ErrorBoundary.wrap(({ channel }) => {
        ...
        return (
            <Card variant="warning" className={Margins.top8} defaultPadding>
                Please do not private message Tinycord plugin developers for support!
                <br />
                Instead, use the Tinycord support channel: {Parser.parse("https://discord.com/channels/1015060230222131221/1026515880080842772")}
