...
const ContributorBadge: ProfileBadge = {
    ...
    description: "Tinycord Contributor",
                        ...
                        <ModalRoot {...props}>
                            ...
                            <ModalContent>
                                ...
                                <div style={{ padding: "1em" }}>
                                    <Forms.FormText>
                                        This Badge is a special perk for Tinycord Donors
                                    </Forms.FormText>
                                    <Forms.FormText className={Margins.top20}>
                                        Please consider supporting the development of Tinycord by becoming a donor. It would mean a lot!!
                                    </Forms.FormText>
                                </div>
                            </ModalContent>
                            <ModalFooter>
