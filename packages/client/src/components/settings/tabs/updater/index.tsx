...
function VesktopSection() {
    ...
    return (
        <Flex className={Margins.bottom20} flexDirection="column" gap="1em">
            <Card variant="info">
                <HeadingSecondary>Vesktop & Tinycord</HeadingSecondary>
                <Paragraph>Vesktop and Tinycord are two separate things. This updater is for Tinycord.</Paragraph>
    ...
    return (
        <SettingsTab>
            ...
            <FormSwitch
                ...
                description="Automatically update Tinycord without confirmation prompt"
                value={settings.autoUpdate}
                onChange={(v: boolean) => settings.autoUpdate = v}
            />
            <FormSwitch
                title="Get notified when an automatic update completes"
                description="Show a notification when Tinycord automatically updates"
