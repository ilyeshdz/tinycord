...
const monacoEsmDir = join(dirname(require.resolve("monaco-editor/package.json")), "esm");
...
const buildConfigs = [
    {
        entryPoints: MonacoWorkerEntryPoints.map(entry => join(monacoEsmDir, entry)),
        bundle: true,
        minify: true,
        format: "iife",
        outbase: monacoEsmDir,
